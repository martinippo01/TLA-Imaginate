...
paramsBlock: OPEN_PARENTHESES params CLOSE_PARENTHESES { $$ = ParamsBlockGrammarAction($2); };
...
objectElement: variableIdentifier DOT variableIdentifier { $$ = ObjectElementGrammarAction($1, $3); };
						 argumentsBlock: OPEN_PARENTHESES arguments CLOSE_PARENTHESES { $$ = ArgumentsBlockGrammarAction($2); };
...
method: DOT optional methodIdentifier paramsBlock { $$ = MethodGrammarAction($2, $3, $4); };
